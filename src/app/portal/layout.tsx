...
type IconName = "home" | "tasks" | "projects" | "board" | "gantt" | "progress" | "updates" | "guide" | "people" | "roles" | "permissions" | "settings";
...
function Icon({ name }: { name: IconName }) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    progress: <><path d="M4 19V9M10 19V5M16 19v-7M22 19V3"/><path d="M2 19h22"/></>,
    ...
    <div className="platform-shell">
      ...
      <aside className="platform-sidebar">
        ...
        <nav aria-label="Workspace">
          ...
          <Item href="/portal/progress" icon="progress">Progress</Item>
