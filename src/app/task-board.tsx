...
const fields =
  "id, task_name, discipline_id, owner, status, priority, progress_stage, design_stage, revision_no, start_date, due_date, percent_complete, notes, progress_note, updated_at";
